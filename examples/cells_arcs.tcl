...
define_arc \
	...
	-pinlist {CLKA CLKB RA RB S sela1 sela2 enA selb1 selb2 enB GCLK} \
	-ic "0 0 $VDD 0 $VDD 0 0 0 $VDD 0 0 0" \
	-vector {0 0 1 R 1 X X X X X X 0} \
	-pin RB \
	{ ICM }
...
define_leakage \
	-prevector_pinlist {CLKA CLKB RA RB S} \
	-prevector {00010 10010 10000 00000 00001 10001} \
	-pinlist {CLKA CLKB RA RB S GCLK} \
	-vector {1 0 0 0 1 1} \
	-when "CLKA*!CLKB*GCLK*!RA*!RB*S" \
	{ ICM }
...
define_leakage \
	-prevector_pinlist {CLKA CLKB RA RB S} \
	-prevector {00110 00010 00000 10000 10001 11001 10001 00001 10001 11001} \
	-pinlist {CLKA CLKB RA RB S GCLK} \
	-vector {1 1 0 0 1 1} \
	-when "CLKA*CLKB*GCLK*!RA*!RB*S" \
	{ ICM }
