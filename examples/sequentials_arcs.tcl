...
define_leakage \
	-prevector_pinlist {CLKA CLKB D} \
	-prevector {001 101 100 000 010 110 111 011} \
	-when "!CLKA*CLKB*D*Q" \
	{ HPIPE }
...
define_leakage \
	-prevector_pinlist {CLKA CLKB DA DB} \
	-prevector {0011 0111 1111 1110 1100} \
	-when "CLKA*CLKB*!DA*!DB*Q" \
	{ DCMUX }
...
define_leakage \
	-prevector_pinlist {CLKA CLKB RA RB S} \
	-prevector {01010 11010 11011 01011 01001 11001} \
	-when "CLKA*CLKB*GCLK*!RA*!RB*S" \
	{ ICM }
...
define_arc \
	-type setup \
	-pinlist {CLKA CLKB RA RB S selb1 selb2 GCLK} \
	-ic "$VDD 0 $VDD $VDD $VDD 0 0 0" \
	-vector {1 R 1 F 1 X X X} \
	-related_pin CLKB \
	-pin RB \
	-probe {selb1 selb2} \
	{ ICM }
