...
define_leakage \
	-prevector_pinlist {CLKA CLKB D} \
	-prevector {000 100 000 001 011 111} \
	-pinlist {CLKA CLKB D Q} \
	-vector {1 1 1 0} \
	-when "CLKA*CLKB*D*!Q" \
	{ HPIPE }
...
define_leakage \
	-prevector_pinlist {CLKA CLKB D} \
	-prevector {001 101 100 000 010 110} \
	-pinlist {CLKA CLKB D Q} \
	-vector {1 1 0 1} \
	-when "CLKA*CLKB*!D*Q" \
	{ HPIPE }
...
define_leakage \
	-prevector_pinlist {CLKA CLKB D} \
	-prevector {001 101 100 000 010 110 111} \
	-pinlist {CLKA CLKB D Q} \
	-vector {1 1 1 1} \
	-when "CLKA*CLKB*D*Q" \
	{ HPIPE }
...
define_leakage \
	-prevector_pinlist {CLKA CLKB D} \
	-prevector {000 100 000 001 011 111 011} \
	-pinlist {CLKA CLKB D Q} \
	-vector {0 1 1 0} \
	-when "!CLKA*CLKB*D*!Q" \
	{ HPIPE }
...
define_leakage \
	-prevector_pinlist {CLKA CLKB D} \
	-prevector {000 100 000 001 011 111 110} \
	-pinlist {CLKA CLKB D Q} \
	-vector {1 1 0 0} \
	-when "CLKA*CLKB*!D*!Q" \
	{ HPIPE }
...
define_leakage \
	-prevector_pinlist {CLKA CLKB D} \
	-prevector {001 101 100 000 010 110 010} \
	-pinlist {CLKA CLKB D Q} \
	-vector {0 1 0 1} \
	-when "!CLKA*CLKB*!D*Q" \
	{ HPIPE }
...
define_leakage \
	-prevector_pinlist {CLKA CLKB D} \
	-prevector {000 100 000 001 011 111 110 010} \
	-pinlist {CLKA CLKB D Q} \
	-vector {0 1 0 0} \
	-when "!CLKA*CLKB*!D*!Q" \
	{ HPIPE }
...
define_leakage \
	-prevector_pinlist {CLKA CLKB D} \
	-prevector {001 101 100 000 010 110 010 011} \
	-pinlist {CLKA CLKB D Q} \
	-vector {0 1 1 1} \
	-when "!CLKA*CLKB*D*Q" \
	{ HPIPE }
...
define_leakage \
	-prevector_pinlist {CLKA CLKB RA RB S} \
	-prevector {01010 11010 11000 01000} \
	-pinlist {CLKA CLKB RA RB S GCLK} \
	-vector {0 1 0 0 0 0} \
	-when "!CLKA*CLKB*!GCLK*!RA*!RB*!S" \
	{ ICM }
...
define_leakage \
	-prevector_pinlist {CLKA CLKB RA RB S} \
	-prevector {01010 11010 01010 01011 01001} \
	-pinlist {CLKA CLKB RA RB S GCLK} \
	-vector {0 1 0 0 1 0} \
	-when "!CLKA*CLKB*!GCLK*!RA*!RB*S" \
	{ ICM }
...
define_leakage \
	-prevector_pinlist {CLKA CLKB RA RB S} \
	-prevector {10101 11101 10101 10100 11100 11000} \
	-pinlist {CLKA CLKB RA RB S GCLK} \
	-vector {1 1 0 0 0 1} \
	-when "CLKA*CLKB*GCLK*!RA*!RB*!S" \
	{ ICM }
...
define_leakage \
	-prevector_pinlist {CLKA CLKB RA RB S} \
	-prevector {01010 11010 01010 01011 01001 11001} \
	-pinlist {CLKA CLKB RA RB S GCLK} \
	-vector {1 1 0 0 1 1} \
	-when "CLKA*CLKB*GCLK*!RA*!RB*S" \
	{ ICM }
...
define_leakage \
	-prevector_pinlist {CLKA CLKB RA RB S} \
	-prevector {10101 11101 10101 10100 11100 11000 11001} \
	-pinlist {CLKA CLKB RA RB S GCLK} \
	-vector {1 1 0 0 1 1} \
	-when "CLKA*CLKB*GCLK*!RA*!RB*S" \
	{ ICM }
...
define_leakage \
	-prevector_pinlist {CLKA CLKB RA RB S} \
	-prevector {01010 11010 01010 01011 01001 11001 11000} \
	-pinlist {CLKA CLKB RA RB S GCLK} \
	-vector {1 1 0 0 0 1} \
	-when "CLKA*CLKB*GCLK*!RA*!RB*!S" \
	{ ICM }
...
define_leakage \
	-prevector_pinlist {CLKA CLKB RA RB S} \
	-prevector {00111 00101 01101 01001 01000 11000 10000 00000} \
	-pinlist {CLKA CLKB RA RB S GCLK} \
	-vector {0 0 0 0 0 0} \
	-when "!CLKA*!CLKB*!GCLK*!RA*!RB*!S" \
	{ ICM }
...
define_leakage \
	-prevector_pinlist {CLKA CLKB RA RB S} \
	-prevector {00111 00101 01101 01001 01000 11000 10000 00000 01000} \
	-pinlist {CLKA CLKB RA RB S GCLK} \
	-vector {0 1 0 0 0 1} \
	-when "!CLKA*CLKB*GCLK*!RA*!RB*!S" \
	{ ICM }
...
define_leakage \
	-prevector_pinlist {CLKA CLKB RA RB S} \
	-prevector {00111 00101 01101 01001 01000 11000 10000 00000 10000} \
	-pinlist {CLKA CLKB RA RB S GCLK} \
	-vector {1 0 0 0 0 1} \
	-when "CLKA*!CLKB*GCLK*!RA*!RB*!S" \
	{ ICM }
...
define_leakage \
	-prevector_pinlist {CLKA CLKB RA RB S} \
	-prevector {00110 00010 10010 10011 10001 11001 10001 11001 11000 01000} \
	-pinlist {CLKA CLKB RA RB S GCLK} \
	-vector {0 1 0 0 0 1} \
	-when "!CLKA*CLKB*GCLK*!RA*!RB*!S" \
	{ ICM }
...
define_leakage \
	-prevector_pinlist {CLKA CLKB RA RB S} \
	-prevector {00111 00101 01101 01001 01000 11000 10000 00000 10000 11000} \
	-pinlist {CLKA CLKB RA RB S GCLK} \
	-vector {1 1 0 0 0 1} \
	-when "CLKA*CLKB*GCLK*!RA*!RB*!S" \
	{ ICM }
...
define_leakage \
	-prevector_pinlist {CLKA CLKB RA RB S} \
	-prevector {00110 00010 10010 10011 10001 11001 10001 11001 01001 11001 11000} \
	-pinlist {CLKA CLKB RA RB S GCLK} \
	-vector {1 1 0 0 0 1} \
	-when "CLKA*CLKB*GCLK*!RA*!RB*!S" \
	{ ICM }
...
define_arc \
	-type setup \
	-pinlist {CLKA CLKB RA RB S selb1 selb2 GCLK} \
	-ic "$VDD 0 $VDD 0 0 0 0 0" \
	-vector {1 R 1 0 R X X X} \
	-related_pin CLKB \
	-pin S \
	-probe {selb1 selb2} \
	{ ICM }
