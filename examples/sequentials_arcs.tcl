...
define_leakage \
	-prevector_pinlist {CLKA CLKB D} \
	-prevector {000 100 101 001 011 111 110} \
	-pinlist {CLKA CLKB D Q} \
	-vector {1 1 0 0} \
	-when "CLKA*CLKB*!D*!Q" \
	{ HPIPE }
...
define_leakage \
	-prevector_pinlist {CLKA CLKB D} \
	-prevector {000 100 101 001 011 111 011} \
	-pinlist {CLKA CLKB D Q} \
	-vector {0 1 1 0} \
	-when "!CLKA*CLKB*D*!Q" \
	{ HPIPE }
...
define_leakage \
	-prevector_pinlist {CLKA CLKB D} \
	-prevector {001 101 001 000 010 110 111} \
	-pinlist {CLKA CLKB D Q} \
	-vector {1 1 1 1} \
	-when "CLKA*CLKB*D*Q" \
	{ HPIPE }
...
define_leakage \
	-prevector_pinlist {CLKA CLKB D} \
	-prevector {001 101 001 000 010 110 010} \
	-pinlist {CLKA CLKB D Q} \
	-vector {0 1 0 1} \
	-when "!CLKA*CLKB*!D*Q" \
	{ HPIPE }
...
define_leakage \
	-prevector_pinlist {CLKA CLKB D} \
	-prevector {001 101 001 000 010 110 010 011} \
	-pinlist {CLKA CLKB D Q} \
	-vector {0 1 1 1} \
	-when "!CLKA*CLKB*D*Q" \
	{ HPIPE }
...
define_leakage \
	-prevector_pinlist {CLKA CLKB D} \
	-prevector {000 100 101 001 011 111 011 010} \
	-pinlist {CLKA CLKB D Q} \
	-vector {0 1 0 0} \
	-when "!CLKA*CLKB*!D*!Q" \
	{ HPIPE }
...
define_leakage \
	-prevector_pinlist {CLKA CLKB DA DB} \
	-prevector {0000 1000 1010 1110 1111} \
	-pinlist {CLKA CLKB DA DB Q} \
	-vector {1 1 1 1 0} \
	-when "CLKA*CLKB*DA*DB*!Q" \
	{ DCMUX }
...
define_leakage \
	-prevector_pinlist {CLKA CLKB DA DB} \
	-prevector {0010 1010 1110 1111 1101} \
	-pinlist {CLKA CLKB DA DB Q} \
	-vector {1 1 0 1 1} \
	-when "CLKA*CLKB*!DA*DB*Q" \
	{ DCMUX }
...
define_leakage \
	-prevector_pinlist {CLKA CLKB DA DB} \
	-prevector {0011 0111 1111 1101 1100} \
	-pinlist {CLKA CLKB DA DB Q} \
	-vector {1 1 0 0 1} \
	-when "CLKA*CLKB*!DA*!DB*Q" \
	{ DCMUX }
...
define_leakage \
	-prevector_pinlist {CLKA CLKB RA RB S} \
	-prevector {00010 00000 10000 00000} \
	-pinlist {CLKA CLKB RA RB S GCLK} \
	-vector {0 0 0 0 0 0} \
	-when "!CLKA*!CLKB*!GCLK*!RA*!RB*!S" \
	{ ICM }
...
define_leakage \
	-prevector_pinlist {CLKA CLKB RA RB S} \
	-prevector {00101 01101 01001 00001} \
	-pinlist {CLKA CLKB RA RB S GCLK} \
	-vector {0 0 0 0 1 0} \
	-when "!CLKA*!CLKB*!GCLK*!RA*!RB*S" \
	{ ICM }
...
define_leakage \
	-prevector_pinlist {CLKA CLKB RA RB S} \
	-prevector {00101 01101 01001 00001 00000} \
	-pinlist {CLKA CLKB RA RB S GCLK} \
	-vector {0 0 0 0 0 0} \
	-when "!CLKA*!CLKB*!GCLK*!RA*!RB*!S" \
	{ ICM }
...
define_leakage \
	-prevector_pinlist {CLKA CLKB RA RB S} \
	-prevector {00010 00000 10000 10001 00001} \
	-pinlist {CLKA CLKB RA RB S GCLK} \
	-vector {0 0 0 0 1 0} \
	-when "!CLKA*!CLKB*!GCLK*!RA*!RB*S" \
	{ ICM }
...
define_leakage \
	-prevector_pinlist {CLKA CLKB RA RB S} \
	-prevector {10111 10101 11101 11001 11000} \
	-pinlist {CLKA CLKB RA RB S GCLK} \
	-vector {1 1 0 0 0 0} \
	-when "CLKA*CLKB*!GCLK*!RA*!RB*!S" \
	{ ICM }
...
define_leakage \
	-prevector_pinlist {CLKA CLKB RA RB S} \
	-prevector {00010 00000 10000 00000 10000} \
	-pinlist {CLKA CLKB RA RB S GCLK} \
	-vector {1 0 0 0 0 1} \
	-when "CLKA*!CLKB*GCLK*!RA*!RB*!S" \
	{ ICM }
...
define_leakage \
	-prevector_pinlist {CLKA CLKB RA RB S} \
	-prevector {10101 10001 11001 10001 11001} \
	-pinlist {CLKA CLKB RA RB S GCLK} \
	-vector {1 1 0 0 1 1} \
	-when "CLKA*CLKB*GCLK*!RA*!RB*S" \
	{ ICM }
...
define_leakage \
	-prevector_pinlist {CLKA CLKB RA RB S} \
	-prevector {00101 01101 01001 00001 01001} \
	-pinlist {CLKA CLKB RA RB S GCLK} \
	-vector {0 1 0 0 1 1} \
	-when "!CLKA*CLKB*GCLK*!RA*!RB*S" \
	{ ICM }
...
define_leakage \
	-prevector_pinlist {CLKA CLKB RA RB S} \
	-prevector {10101 10001 11001 10001 10000} \
	-pinlist {CLKA CLKB RA RB S GCLK} \
	-vector {1 0 0 0 0 0} \
	-when "CLKA*!CLKB*!GCLK*!RA*!RB*!S" \
	{ ICM }
...
define_leakage \
	-prevector_pinlist {CLKA CLKB RA RB S} \
	-prevector {00010 00000 10000 00000 10000 10001} \
	-pinlist {CLKA CLKB RA RB S GCLK} \
	-vector {1 0 0 0 1 1} \
	-when "CLKA*!CLKB*GCLK*!RA*!RB*S" \
	{ ICM }
...
define_leakage \
	-prevector_pinlist {CLKA CLKB RA RB S} \
	-prevector {10101 10001 11001 10001 10000 11000} \
	-pinlist {CLKA CLKB RA RB S GCLK} \
	-vector {1 1 0 0 0 1} \
	-when "CLKA*CLKB*GCLK*!RA*!RB*!S" \
	{ ICM }
...
define_leakage \
	-prevector_pinlist {CLKA CLKB RA RB S} \
	-prevector {00101 01101 01001 00001 00000 01000} \
	-pinlist {CLKA CLKB RA RB S GCLK} \
	-vector {0 1 0 0 0 1} \
	-when "!CLKA*CLKB*GCLK*!RA*!RB*!S" \
	{ ICM }
...
define_leakage \
	-prevector_pinlist {CLKA CLKB RA RB S} \
	-prevector {00101 01101 01001 00001 00000 01000 01001} \
	-pinlist {CLKA CLKB RA RB S GCLK} \
	-vector {0 1 0 0 1 1} \
	-when "!CLKA*CLKB*GCLK*!RA*!RB*S" \
	{ ICM }
...
define_leakage \
	-prevector_pinlist {CLKA CLKB RA RB S} \
	-prevector {00110 00010 10010 10000 10001 11001 10001 00001} \
	-pinlist {CLKA CLKB RA RB S GCLK} \
	-vector {0 0 0 0 1 0} \
	-when "!CLKA*!CLKB*!GCLK*!RA*!RB*S" \
	{ ICM }
...
define_leakage \
	-prevector_pinlist {CLKA CLKB RA RB S} \
	-prevector {00111 00101 00001 01001 01000 11000 10000 11000 01000} \
	-pinlist {CLKA CLKB RA RB S GCLK} \
	-vector {0 1 0 0 0 1} \
	-when "!CLKA*CLKB*GCLK*!RA*!RB*!S" \
	{ ICM }
...
define_leakage \
	-prevector_pinlist {CLKA CLKB RA RB S} \
	-prevector {00110 00010 10010 10000 10001 11001 10001 00001 01001} \
	-pinlist {CLKA CLKB RA RB S GCLK} \
	-vector {0 1 0 0 1 1} \
	-when "!CLKA*CLKB*GCLK*!RA*!RB*S" \
	{ ICM }
...
define_leakage \
	-prevector_pinlist {CLKA CLKB RA RB S} \
	-prevector {00110 00010 10010 10000 10001 11001 10001 00001 01001 11001} \
	-pinlist {CLKA CLKB RA RB S GCLK} \
	-vector {1 1 0 0 1 1} \
	-when "CLKA*CLKB*GCLK*!RA*!RB*S" \
	{ ICM }
...
define_leakage \
	-prevector_pinlist {CLKA CLKB RA RB S} \
	-prevector {00111 00101 00001 01001 01000 11000 01000 11000 11001 10001} \
	-pinlist {CLKA CLKB RA RB S GCLK} \
	-vector {1 0 0 0 1 1} \
	-when "CLKA*!CLKB*GCLK*!RA*!RB*S" \
	{ ICM }
...
define_leakage \
	-prevector_pinlist {CLKA CLKB RA RB S} \
	-prevector {00111 00101 00001 01001 01000 11000 01000 11000 11001 10001 11001} \
	-pinlist {CLKA CLKB RA RB S GCLK} \
	-vector {1 1 0 0 1 1} \
	-when "CLKA*CLKB*GCLK*!RA*!RB*S" \
	{ ICM }
