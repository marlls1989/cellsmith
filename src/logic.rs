...
/// The derived order exists so a caller may sort a slice of literals: two conditions naming the
/// same literal set then sort to the same sequence and compare structurally equal.
